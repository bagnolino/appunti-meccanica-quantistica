...
Da cui notiamo \(\ket{\psi}= \sum_{n=1}^{\infty}\ket{n}\braket{n}{\psi} \implies \mathbb{I}_n= \sum_{n=1}^{\infty} \dyad{n}{n}\)
...
\begin{proof}
    ...
    \]
    \[
        (\Delta\mathcal{A})_{\hat{a},\Sigma} = 0 \iff (A-\hat{a}\mathbb{I})\Psi=0 
    \]    
\end{proof}
...
\{ q_j, p_k \} = \delta_{jk}
\;\;\longrightarrow\;\;
\frac{1}{i\hbar}[Q_j, P_k] = \delta_{jk}\,\mathbb{I}
\]
...
\begin{definition}
    ...
    \begin{equation}
        U^\dagger U = \mathbb{I} = UU^\dagger \iff U^\dagger = U^{-1}
    \end{equation}
\end{definition}
...
\begin{itemize}
    ...
    \item \(U(t,t) = \mathbb{I} \ \forall\,t\) .
    \item \(U(t_2,t_1)U(t_1,t_0)\ket{\Psi(t_0)}= U(t_2,t_0)\ket{\Psi(t_0)} \implies  U (t_0,t)U(t,t_0)= \mathbb{I}\) .
...
\]
\[
\Rightarrow \quad U(t,t_0) = \mathbb{I} - \frac{i}{\hbar}\int_{t_0}^{t} H(t')U(t',t_0)\dd{t'}
\]
...
\]
e inserendo dei \(UU^\dagger = \mathbb{I}\) otteniamo:
\[
