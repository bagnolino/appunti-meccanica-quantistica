...
\begin{itemize}
    \item Spazio H 1° particella: \(\mathcal{H}_{\vec{x}_1} \otimes \mathcal{H}_{s_1}\)
    \item Spazio H 2° particella: \(\mathcal{H}_{\vec{x}_2} \otimes \mathcal{H}_{s_2}\)
\end{itemize}
...
\[
\vec{p}^2 = p_r^2 + p_\perp^2 = p_r^2 + \frac{\vec{l}^2}{r^2}
\]
...
Sappiamo già dalla trattazione in \ref{sec: particella3d} che le soluzioni hanno la forma \[\Psi_{E, \ell, m}(r, \vartheta, \varphi)= f_{E,\ell,m}(r)Y^m_\ell(\vartheta,\varphi)\]
...
Anche se \( V(r) \) non è limitato nell'origine, grazie al \textbf{Teorema di Kato-Rellich} possiamo affermare che il dominio dell'Hamiltoniana coincide con quello dell'energia cinetica:
\[
D(H) = D(\vec{P}^2)
\]
