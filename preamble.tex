...
\KOMAoptions{headinclude=false,footinclude=true}    % Bilanciamento margini KOMA
...
\usepackage[backend=biber,style=alphabetic,maxbibnames=9]{biblatex} % Gestione bibliografia
\addbibresource{biblio/references.bib} % File della bibliografia

\usepackage[hidelinks]{hyperref} % Link interni ed esterni (deve essere quasi l ultimo)
...
\newtheorem*{postulato4}{Postulato della probabilit di una misura}
